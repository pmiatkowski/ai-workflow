...
```
⚠ Coding instructions already defined at .ai-workflow/memory/coding-rules/index.md
...
1. Read existing `.ai-workflow/memory/coding-rules/index.md`
...
After collecting all answers, create `.ai-workflow/memory/coding-rules/index.md` using the detailed template:
...
1. Create directory: `.ai-workflow/memory/coding-rules/{category}/`
2. Create category index: `.ai-workflow/memory/coding-rules/{category}/index.md`
3. Add individual rule files: `.ai-workflow/memory/coding-rules/{category}/{rule-name}.md`
...
1. Ensure `.ai-workflow/memory/coding-rules/` directory exists (create if needed)
2. Write content to `.ai-workflow/memory/coding-rules/index.md`
...
```
✓ Created .ai-workflow/memory/coding-rules/index.md
...
```
✓ Updated .ai-workflow/memory/coding-rules/index.md
...
| No .ai-workflow directory exists | Create directory structure first |
...
- **Directory creation**: Create `.ai-workflow/memory/coding-rules/` if it doesn't exist
